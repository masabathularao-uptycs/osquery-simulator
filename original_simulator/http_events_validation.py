...
with open("rhel7-test2.log", "r") as fin:
    line_no = 1
    for line in fin:
        if line_no % 2 == 0 and line_no <= input_lines: 
            ...
            for table_details in lines["data"]:
                ...
                if table_details['name'] == 'socket_events':
                    if table_details['columns']['action'] == 'connect' and table_details['columns']['family'] == '2' and table_details['columns']['type'] == '2':
           ...
           pass 
        line_no += 1 
    #print(process_file_events['process_file_events_10_alert-builder-added']*126)
    #print(process_file_events['process_file_events_3_alert-builder-added']*126)
    #print(process_file_events['process_file_events_4_alert-builder-added']*126)
    #print(process_file_events['process_file_events_9_alert-builder-added']*126)
    #print(process_file_events['process_file_events_6_alert-builder-added']*126)
    #print(process_file_events['process_file_events_7_alert-builder-added']*126)
    #print(process_file_events['process_file_events_5_alert-builder-added']*126)
    #print(process_file_events['process_file_events_alert-builder-added']*126)
    #print(process_file_events['process_file_events_8_alert-builder-added']*126)


    #print(socket_events['socket_events_4_alert-builder-added']*126)
    #print(socket_events['socket_events_1_alert-builder-added']*126)
    #print(socket_events['socket_events_3_alert-builder-added']*126)
    #print(socket_events['socket_events_2_alert-builder-added']*126)
    #print(socket_events['socket_events_5_alert-builder-added']*126)
    #print(socket_events['socket_events_alert-builder-added']*126)
    #print(socket_events['socket_events_6_alert-builder-added']*126)
#
    #print(process_events['process_events_alert-builder-added']*12000)
    #print(process_events['process_events_1_alert-builder-added']*12000)
    #print(process_events['process_events_4_alert-builder-added']*12000)
    #print(process_events['process_events_7_alert-builder-added']*12000)
    #print(process_events['process_events_3_alert-builder-added']*12000)
    #print(process_events['process_events_9_alert-builder-added']*12000)
    #print(process_events['process_events_8_alert-builder-added']*12000)
    #print(process_events['process_events_2_alert-builder-added']*12000)
    #print(process_events['process_events_10_alert-builder-added']*12000)
    #print(process_events['process_events_5_alert-builder-added']*12000)
    #print(process_events['process_events_added_ruleengine_replay']*12)
#
    #print(sum(dns_lookup_events.values())*63*2)
    #print(sum(process_events.values())*126)
    #print(sum(socket_events.values())*126)
    #print(sum(process_file_events.values())*126)
    dict1 = {}
