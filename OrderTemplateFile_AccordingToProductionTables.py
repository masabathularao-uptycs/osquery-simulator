# import random, os
import json
from simulator_config_vars import OSQUERY_TABLES_TEMPLATE_FILE,OSQUERY_TABLES_IMPORTACE_ORDER

import csv

def order_template_file():
    with open(OSQUERY_TABLES_IMPORTACE_ORDER, mode='r') as file:
