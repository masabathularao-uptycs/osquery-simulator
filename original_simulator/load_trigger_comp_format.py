...
num_of_repeats=loadinput['repeat_input_file']
    ...
    with open(loadinput['inputfile']) as fs:
      ...
      while 1:
        ...
        if len(con) > 50065000:
          ...
          continue
        logging.warning("Line number : " +str(linenumber) + ',tstamp : ' + starttimestr + ' ' + str(len(con)) + ' ' + ",replay number : " +str(repeat) + ' ' + ",expected replays : " +str(num_of_repeats))
        analyse(Con)
        ...
        #time.sleep(3)
        first_ts=second_ts
        if endline != 0 and num_of_repeats==0:
           if endline <= linenumber:
              break
        elif endline != 0 and num_of_repeats != 0:
           if endline <= linenumber and repeat < num_of_repeats:
              ...
              #first_ts=fs.readline()
              #print 'first_ts',first_ts
           elif endline <= linenumber and repeat>=num_of_repeats:
              break
    statsflag=False      
