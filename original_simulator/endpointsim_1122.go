...
func init() {
	...
	port = *port_flag
	count = *count_flag
	enrollurl = fmt.Sprintf("https://%s.uptycs.io/agent/enroll", domain)
	configurl = fmt.Sprintf("https://%s.uptycs.io/agent/config", domain)
	logurl = fmt.Sprintf("https://%s.uptycs.io/agent/log", domain)
	distributedreadurl = fmt.Sprintf("https://%s.uptycs.io/agent/distributed_read", domain)
	distributedwriteurl = fmt.Sprintf("https://%s.uptycs.io/agent/distributed_write", domain)
	enrollReqTimeout = 30
	configInterval = 300
	distInterval = 200
